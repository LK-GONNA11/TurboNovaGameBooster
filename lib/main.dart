...
class _TurboBoosterPageState extends State<TurboBoosterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('TurboNova Game Booster'), centerTitle: true),
      body: Padding(
              ...
              child: AnimatedContainer(
                ...
                child: Center(
                  child: _isBoosting
                      ...
                      : const Text("BOOST", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ),
            ),
            const SizedBox(height: 40),
